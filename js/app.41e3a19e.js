        ...
        var St = new r["a"](),
            Pt = {
                ...
                props: {
                    ...
                    prompt: { default: "~mr@sujan:#/", type: String },
                    showHelp: { default: !1, type: Boolean },
                    showIntro: { default: !1, type: Boolean },
                    stdin: { default: "", type: String },
                    title: { default: "portfolio@sujan: ~", type: String },
                },
                data: function () {
                ...
                data: function () {
                    return {
                        ...
                        commands: {
                            ...
                            about: function () {
                                return N(
                                    "\n        &nbsp;<span class='ef'>Enthusiastic Web Developer with top-notch skills & proven ability in optimizing web <br> functionalities that improve data retrieval & workflow efficiencies. ♓</span><br>\n        &nbsp;<b class='cd'>Exp:</b> <span class='ef'>2 Yrs +</span><br>\n        &nbsp;<b class='cd'>Skills:</b> <span class='ef'>PHP, Laravel, MysQl, Js, React Js, Bootstrap ..</span><br>\n        &nbsp;<b class='cd'>Working:</b> <span class='ef'>I’m currently working on Laravel & React Js ..</span><br>\n        &nbsp;<b class='cd'>Tools:</b> <span class='ef'>Docker,VsCode, Atom, Postman, Draw.io, Git, GitHub  ..</span><br>\n        &nbsp;<b class='cd'>Learning:</b> <span class='ef'>I’m currently learning Docker ..</span><br>\n        &nbsp;<b class='cd'>Ask?:</b> <span class='ef'>Ask me about #Laravel #PHP #MySQL #ReactJS ..</span><br>\n        &nbsp;<b class='cd'>Hobby:</b> <span class='ef'>Coding, Reading Books, Watching Movies, Travelling..</span><br>\n      "
                                );
                            },
                            contact: function () {
                                return N(
                                    "\n\n        &nbsp;<b class='cd'>Mobile:</b> <span class='ef' target='_blank'>01910005054</span><br>\n        &nbsp;<b class='cd'>Email:</b> <span class='ef' target='_blank'>sujanmahmudovi@gmail.com</span><br>\n        &nbsp;<b class='cd'>Address:</b> <span class='ef' target='_blank'>Dhanmondi, Dhaka, Bangladesh</span><br>\n      "
                                );
                            },
                            link: function () {
                                return N(
                                    "\n\n        &nbsp;<b><a class='ab' target='_blank' href='https://github.com/sujan97825'>Github</a>,\n         <a class='ab' target='_blank' href='#'>StackOverFlow</a>\n         </b><br>\n        &nbsp;<b class='cd'>SocialMedia:</b>\n         <ul>\n             <li><a class='ef' target='_blank' href=\"https://www.linkedin.com/in/sujan97825/\">LinkedIn</a></li>\n         <li><a class='ef' target='_blank' href=\"https://www.facebook.com/sjn97825\">FaceBook</a></li>\n\n         </ul>\n\n         <br>\n      "
                                );
                            },
                        },
                        cursor: 0,
